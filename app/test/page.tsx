...
import { Bug, TestTube, ListTodo, User, ArrowRight, GitBranch, Clock, AlertCircle, CheckCircle2 } from "lucide-react";
...
export default function DashboardPage() {
  return (
    <div className="min-h-screen w-full" style={{ background: "#F5E8C7" }}>
      {/* NAVBAR */}
      <header className="sticky top-0 z-40 w-full border-b shadow-sm" style={{ borderColor: "#C59B80", background: "#F5E8C7" }}>
        <div className="mx-auto flex max-w-[1600px] items-center justify-between px-6 py-3">
          <div className="flex items-center gap-8">
            <div className="flex items-center gap-3">
              <div className="h-9 w-9 rounded-lg flex items-center justify-center" style={{ background: "#A86F5C" }}>
                <Bug className="h-5 w-5 text-white" />
              </div>
              <span className="text-lg font-bold tracking-tight" style={{ color: "#5A3A32" }}>BeaverWorldDev</span>
            </div>
            
            <nav className="hidden items-center gap-1 md:flex">
              {[
                { label: 'Issue Tracker', icon: Bug, active: false },
                { label: 'Scenario Test', icon: TestTube, active: false },
                { label: 'Task Boards', icon: ListTodo, active: false },
                ...
                <a
                  ...
                  style={{
                    background: active ? "#DEBA9D" : "transparent",
                    color: "#5A3A32",
                  }}
                >
          ...
          <div className="flex items-center gap-3">
            <span className="text-sm font-medium hidden md:block" style={{ color: "#5A3A32" }}>John Doe</span>
            <Avatar className="h-8 w-8 cursor-pointer">
              <AvatarFallback style={{ background: "#A86F5C", color: "#fff" }}>
