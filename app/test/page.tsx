    ...
    <div className="min-h-screen bg-[hsl(var(--background))] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-5xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-0 bg-[hsl(var(--card))] rounded-2xl shadow-lg overflow-hidden border border-[hsl(var(--border))]">
          ...
          <div className="hidden lg:flex flex-col items-center justify-center p-12 bg-gradient-to-br from-[hsl(var(--background))] to-[hsl(var(--accent))]">
            <div className="flex flex-col items-center gap-8">
              ...
              <div className="flex flex-col gap-6 text-center max-w-sm">
                ...
                <div className="flex justify-center gap-2 pt-4">
                  ...
                  <div className="h-2 w-2 rounded-full bg-[hsl(var(--secondary))]" />
                  <div className="h-2 w-2 rounded-full bg-[hsl(var(--primary))]" />
                </div>
              </div>
            </div>
